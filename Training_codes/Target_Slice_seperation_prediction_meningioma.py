...
if __name__ == "__main__":
    ...
    # Paths
    # -------------------------------
    input_folder = r"Transfer learning\UDA_MRI\Datasets\Target\meningioma"

    # Define custom output folders for each class
    output_folders = {
        "Axial":    r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Axial\Target\meningioma",
        "Coronal":  r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Coronal\Target\meningioma",
        "Sagittal": r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Sagittal\Target\meningioma"
    }
