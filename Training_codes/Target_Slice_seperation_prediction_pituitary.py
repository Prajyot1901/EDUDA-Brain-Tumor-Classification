...
if __name__ == "__main__":
    ...
    # Paths
    # -------------------------------
    input_folder = r"Transfer learning\UDA_MRI\Datasets\Target\pituitary"

    # Define custom output folders for each class
    output_folders = {
        "Axial":    r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Axial\Target\pituitary",
        "Coronal":  r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Coronal\Target\pituitary",
        "Sagittal": r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Sagittal\Target\pituitary"
    }
