...
if __name__ == "__main__":
    ...
    # Paths
    # -------------------------------
    input_folder = r"Transfer learning\UDA_MRI\Datasets\Source\glioma"

    # Define custom output folders for each class
    output_folders = {
        "Axial":    r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Axial\Source\glioma",
        "Coronal":  r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Coronal\Source\glioma",
        "Sagittal": r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Sagittal\Source\glioma"
    }
