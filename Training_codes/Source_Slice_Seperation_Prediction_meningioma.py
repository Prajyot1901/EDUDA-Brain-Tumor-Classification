...
if __name__ == "__main__":
    ...
    # Paths
    # -------------------------------
    input_folder = r"Transfer learning\UDA_MRI\Datasets\Source\meningioma"

    # Define custom output folders for each class
    output_folders = {
        "Axial":    r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Axial\Source\meningioma",
        "Coronal":  r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Coronal\Source\meningioma",
        "Sagittal": r"Transfer learning\UDA_MRI\Slice_Separated_Dataset\Sagittal\Source\meningioma"
    }
